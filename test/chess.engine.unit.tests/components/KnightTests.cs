...
public class KnightTests
{
    ...
    [DataRow('h', 7, new[] { "f6", "f8", "g5" })]
    [DataRow('h', 8, new[] { "f7", "g6" })]
    public void GetValidMoves_Knight_AllPossiblePositionsWhenSpaceTakenWithSameColour(char rank, int file, string[] expectedSquares)
    {
        var board = new Board();
        foreach (Piece.PieceColour colour in Enum.GetValues(typeof(Piece.PieceColour)))
        {
    ...
    [DataRow('h', 7, new[] { "f6", "f8", "g5" })]
    [DataRow('h', 8, new[] { "f7", "g6" })]
    public void GetValidMoves_Knight_NoPossiblePositionsWhenAllSpacesTakenWithSameColour(char rank, int file, string[] expectedSquares)
    {
        var board = new Board();
        foreach (Piece.PieceColour colour in Enum.GetValues(typeof(Piece.PieceColour)))
        {
    ...
    [DataRow('h', 7, new[] { "f6", "f8", "g5" })]
    [DataRow('h', 8, new[] { "f7", "g6" })]
    public void GetValidMoves_Knight_AllPossiblePositionsWhenAllSpacesTakenWithOppositeColour(char rank, int file, string[] expectedSquares)
    {
        var board = new Board();
        foreach (Piece.PieceColour colour in Enum.GetValues(typeof(Piece.PieceColour)))
        {
